...
<div class="container">
    ...
    <div class="search-filter">
        <form action="deals-u.jsp" method="get" style="flex:1; display:flex; min-width:200px;">
        ...
        <form action="deals-u.jsp" method="get" style="flex:0.5; min-width:150px;">
            <select name="category">
                ...
                %>
                    <option value="<%= catId %>" <%= catId.equals(selectedCategory) ? "selected" : "" %>><%= crs.getString("name") %></option>
                <%
                    }
                    conn.close();
